# Практическое занятие: Мониторинг в Kubernetes
...
1. Настройте сбор логов конкретного приложения
2. Создайте дашборд для анализа логов
3. Настройте интеграцию алертов с Slack/Telegram
4. Добавьте custom метрики в демо-приложение 